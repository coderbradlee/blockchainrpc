// Copyright 2016 The blockchainrpc Authors
...
// This test reproduces https://github.com/ethereum/blockchainrpc/issues/17837 where the
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("blockchainrpc-test-ipc-%d-%d", os.Getpid(), rand.Int63())
